...
export const Success: React.FC<props> = ({ text, title, subtext }) => {
  ...
  return (
    <SuccessModal>
      <h1
        className={`${Lora.className} text-[25px] font-normal text-textBlack2 `}
      >
        {title}
      </h1>
      <img src="/assets/success.svg" className="w-[22%] mt-8" />
      <p
        className={`${Raleway.className} w-[55%] mx-auto font-extralight text-[18px] text-center text-textBlack2`}
      >
        {text}
      </p>
      <p
