        ...
        <div className='w-[82%] mx-auto'>
          <div className='flex justify-between'>
            <div className='w-[50%] mt-[8rem]'>
              ...
              <h4 className='text-darkText pt-4 font-medium tracking-wide text-[31px] leading-[2rem]'>Effortless Property</h4>
              <h4 className='text-darkText pt-4 font-medium tracking-wide text-[31px] leading-[1rem]'> Management at Your Fingertips</h4>
            ...
            <img src='/assets/1st.png' className='w-[48%] h-full object-center object-cover' />
          </div>
          <div className='flex justify-between'>
            <img src='/assets/2nd.png' className='w-[42%] h-full object-center object-cover' />
            <div className='w-[50%] mt-[8rem]'>
              <p className='px-[.5rem] py-[.7rem] bg-[#ced4f3] bg-opacity[0.8] w-[36%] text-colorPrimary text-[11px] font-normal tracking-wider text-center'>WHY MYPROPSMANAGER?</p>
              <h4 className='text-darkText pt-4 font-medium tracking-wide text-[32px] leading-[2.7rem]'>Enhancing Your <br/>Rental Experience</h4>
          ...
          <div className='flex justify-between'>
            <div className='w-[50%] mt-[8rem]'>
              ...
              <h4 className='text-darkText pt-4 font-medium tracking-wide text-[32px] leading-[2rem]'>Effortless</h4>
              <h4 className='text-darkText pt-4 font-medium tracking-wide text-[32px] leading-[1rem]'>Documentation Management</h4>
