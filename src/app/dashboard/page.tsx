              ...
              <div className=" flex items-center">
                ...
                <div className="flex flex-col">
                  ...
                  <span className="flex items-center justify-center">
                    ...
                    >
                      Welcome to props manager app! to get started, please
                      verify your email address to unlock all the features and
                      benefits awaiting you.Thank you for joining us!{" "}
                      <span
            ...
            <div className=" lg:flex-row flex flex-wrap lg:gap-[1%] gap-[3%] sm:flex-row md:flex-row md:gap-[3%] gap-y-[1rem] md:gap-y-[1rem] md:flex-wrap lg:flex-nowrap">
              ...
              <div className="lg:w-[15%] w-[45%] md:w-[25%]">
                <TenancyBox
                  ...
                  subtext={`${
                    allTenancyDetails[0]?.landlord_detail.firstName || ""
                  } 
                ${allTenancyDetails[0]?.landlord_detail.lastName || "nil"}`}
                />
              </div>
            </div>
          </div>
